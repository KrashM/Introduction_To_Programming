...
**Задача 5:** Да се напише програма, в която се въвежда цяло положително число n и след това n на брой цели числа (елементи на масив). Да се напише функция, която намира, кой от елементите в този масив се повтаря. **Функцията трябва да работи със сложност по време O(n) и сложност по памет O(1)**.
