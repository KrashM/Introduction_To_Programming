...
void TransformSequence(int arr[], size_t const size){
...
bool IsSawSequence(int const arr[], size_t const size){
...
int main(){
    ...
    std::cout << std::boolalpha << IsSawSequence(arr, size) << '\n';

    if(!IsSawSequence(arr, size)) TransformSequence(arr, size);
